  ...
  return (
    <div>
      ...
      <p>
        ...
        {" / "}
        <a href="https://api.escuelajs.co/api/v1/users/156" className="link">
          admin
        </a>
      </p>
    </div>
...
function Login() {
  ...
  function handleLogin(values) {
    ...
    // redirect to homepage/dasboard
    if (user.email === "admin@gmail.com")
      window.location.replace("/test-covet-lux/admin/analyst");
    else window.location.replace("/test-covet-lux");
  }
